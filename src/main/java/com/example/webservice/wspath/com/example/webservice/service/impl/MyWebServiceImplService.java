 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceImplService", targetNamespace = "http://impl.Service.webservice.example.com/", wsdlLocation = "http://127.0.0.1:12345/myservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.Service.webservice.example.com/", "MyWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:12345/myservice?wsdl");
    ...
    public MyWebServiceImpl getMyWebServiceImplPort() {
        return super.getPort(new QName("http://impl.Service.webservice.example.com/", "MyWebServiceImplPort"), MyWebServiceImpl.class);
    }
    ...
    public MyWebServiceImpl getMyWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.Service.webservice.example.com/", "MyWebServiceImplPort"), MyWebServiceImpl.class, features);
    }
